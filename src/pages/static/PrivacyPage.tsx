...
const PrivacyPage: FC = () => {
  ...
  <div className="max-w-[1480px] mx-auto px-[clamp(20px,4vw,56px)] pb-[100px]">
    ...
    <div className="pt-[72px] pb-14 border-b border-rule mb-16 max-[640px]:pt-12 max-[640px]:pb-10 max-[640px]:mb-10">
      <span className="font-body text-[11px] tracking-[.2em] text-muted uppercase mb-3.5 block">PRIVACY POLICY</span>
    ...
    <div className="max-w-[760px] mb-16">
      <section className={SECTION}>
        ...
        <ul className="pr-5 my-2.5 flex flex-col gap-2">
          ...
          <li className={LI}>اطلاعات پرداخت (پردازش توسط درگاه مجاز — ما اطلاعات کارت را ذخیره نمی‌کنیم)</li>
          <li className={LI}>تاریخچه‌ی سفارش‌ها</li>
        </ul>
        <p className={P}>همچنین به‌صورت خودکار اطلاعاتی مانند آدرس IP، نوع مرورگر، و صفحاتی که بازدید می‌کنید جمع‌آوری می‌شود — صرفاً برای بهبود تجربه‌ی کاربری.</p>
      </section>
      ...
      <section className={SECTION}>
        ...
        <p className={P}>اطلاعات شخصی شما را به هیچ شخص ثالثی برای اهداف تبلیغاتی نمی‌فروشیم. اطلاعات تنها در موارد زیر به اشخاص ثالث منتقل می‌شود:</p>
        <ul className="pr-5 my-2.5 flex flex-col gap-2">
      ...
      <section className={SECTION}>
        ...
        <p className={P}>تمام تبادل داده‌ها از طریق پروتکل HTTPS رمزگذاری می‌شود. اطلاعات کارت بانکی هرگز روی سرورهای ما ذخیره نمی‌شود و پردازش آن کاملاً توسط درگاه پرداخت مجاز انجام می‌شود.</p>
      </section>

      <section className={SECTION}>
        <h2 className={H2}>۵. کوکی‌ها</h2>
        <p className={P}>از کوکی‌های ضروری برای عملکرد سبد خرید و احراز هویت استفاده می‌کنیم. کوکی‌های تبلیغاتی یا ردیابی شخص ثالث بدون رضایت صریح شما فعال نمی‌شوند.</p>
      </section>
      ...
      <section className={SECTION}>
        ...
        <p className={P}>برای هر یک از این درخواست‌ها از طریق صفحه‌ی تماس با ما در ارتباط باشید.</p>
      </section>

      <section className={SECTION}>
        <h2 className={H2}>۷. نگهداری اطلاعات</h2>
        <p className={P}>اطلاعات حساب کاربری تا زمانی که حساب فعال است نگهداری می‌شود. اطلاعات سفارش‌ها برای مقاصد حسابداری و قانونی حداقل ۵ سال نگهداری می‌شود.</p>
      </section>

      <section className={SECTION}>
        <h2 className={H2}>۸. تغییرات در این سیاست</h2>
        <p className={P}>در صورت تغییر عمده در این سیاست، از طریق ایمیل یا اطلاعیه در سایت به شما اطلاع داده می‌شود. ادامه‌ی استفاده از سایت پس از اطلاع‌رسانی به منزله‌ی پذیرش تغییرات است.</p>
      </section>

      <section className={SECTION}>
        <h2 className={H2}>۹. تماس</h2>
        <p className={P}>برای هرگونه سوال درباره‌ی حریم خصوصی یا درخواست دسترسی به اطلاعاتتان، از طریق فرم تماس یا آدرس ایمیل <span style={{ fontFamily: 'var(--mono)', direction: 'ltr', display: 'inline-block' }}>privacy@luxera.ir</span> با ما در ارتباط باشید.</p>
      </section>
    </div>
  </div>
)
