...
const SECTIONS: FaqSection[] = [
  {
    ...
    items: [
      ...
      { q: 'چطور مطمئن شوم سایز درست انتخاب کرده‌ام؟', a: 'در صفحه‌ی هر محصول دکمه‌ی «راهنمای سایز» وجود دارد. برای گردنبند: با متر نواری اندازه‌ی گردن را بگیرید. اگر شک داشتید ۴۵ سانت برای اکثر افراد مناسب است. همچنین تا ۴ روز امکان تعویض وجود دارد.' },
  ...
  },
  {
    title: 'ارسال و تحویل',
    items: [
      { q: 'هزینه‌ی ارسال چقدر است؟', a: 'ارسال برای سفارش‌های بالای ۲٫۵ میلیون تومان رایگان است. برای سفارش‌های کمتر، هزینه‌ی ارسال جداگانه محاسبه می‌شود.' },
  ...
  },
  {
    ...
    items: [
      { q: 'آیا می‌توانم محصول را برگردانم؟', a: 'بله. تا ۴ روز پس از دریافت، اگر قطعه سالم باشد، پلاک داشته باشد و در بسته‌بندی اصلی باشد، می‌توانید آن را برگردانید. پس از ۴ روز امکان پذیرش مرجوعی وجود ندارد.' },
