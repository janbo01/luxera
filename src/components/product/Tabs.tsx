      ...
      <div className="tab-panels">
        ...
        <div className={`tab-panel ${activeTab === 'care' ? 'is-active' : ''}`}>
          <div>
            ...
            <p className="tab-panel__lead-p">برای حفظ درخششِ طلایی، چند نکته‌ی ساده را رعایت کنید: قطعه را پیش از حمام، شنا یا ورزش از خود جدا کنید. در تماس با عطر، اسپری مو و موادِ شوینده قرار ندهید. پس از هر بار استفاده، با پارچه‌ای نرم آن را تمیز کنید و در کیسه‌ی مخملیِ همراه نگه دارید.</p>
          </div>
          <div>
            <h4 className="tab-panel__feat-h">
