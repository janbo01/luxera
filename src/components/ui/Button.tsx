...
const BASE = 'inline-flex items-center gap-2.5 font-medium tracking-[0.01em] border rounded-full transition-all duration-200 cursor-pointer [&>svg]:w-3.5 [&>svg]:h-3.5 [&>svg]:shrink-0 [&_.arr]:inline-block [&_.arr]:w-4 [&_.arr]:h-4 [&_.arr]:transition-transform [&:hover_.arr]:-translate-x-[3px] disabled:opacity-50 disabled:cursor-not-allowed disabled:pointer-events-none'
...
export const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  ({ variant = 'primary', className = '', isLoading = false, disabled, children, ...rest }, ref) => {
