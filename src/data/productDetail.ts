...
export const PRODUCT_DETAIL: ProductDetail = {
  ...
  reviewCount: 184,
  stockCount: 3,
  description: `گردنبند آوای مهتاب یک جواهر فانتزی ظریف با طرحی شیک و مدرن است. زنجیر نازک ۴۵ سانتی با روکش طلایی و پاندانت کریستالی، قطعه‌ای می‌سازد که هم برای استفاده‌ی روزمره مناسب است، هم برای مناسبت‌های خاص.

پایه‌ی فلزی از آلیاژ بدون نیکل ساخته شده و برای پوست‌های حساس ایمن است. روکش طلایی با ضخامت مناسب، در برابر عرق و رطوبت روزمره مقاوم است و با مراقبت ساده درخشش خود را حفظ می‌کند.`,
  highlights: [
    'جواهر فانتزی با طرح شیک و پوشیدنی روزانه',
    'روکش طلایی با پایه‌ی فلزی بدون نیکل — مناسب پوست حساس',
    'پاندانت کریستالی با درخشش بالا',
    'ضمانت یک ساله‌ی کیفیت از لوکسرا',
  ],
  specs: [
    ['جنس',           'آلیاژ بدون نیکل با روکش طلایی'],
    ['وزن',           '۴٫۵ گرم'],
