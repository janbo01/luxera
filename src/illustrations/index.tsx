...
export const NecklaceA: FC<SVGProps<SVGSVGElement>> = () => (
  <Plate>
    ...
    {[0,1,2,3,4,5,6,7,8].map((i) => {
      ...
      return <circle key={i} cx={x} cy={y} r="1.2" fill="currentColor" stroke="none" opacity="0.25" />
    })}
    {/* Pendant drop */}
    <line x1="100" y1="140" x2="100" y2="158" strokeWidth="0.7" opacity="0.6" />
    {/* Pendant — teardrop diamond */}
    <path d="M100 165 L89 176 L100 200 L111 176 Z" strokeWidth="0.9" fill="currentColor" fillOpacity="0.12" />
    ...
    <ellipse cx="97" cy="179" rx="2" ry="1.2" fill="white" stroke="none" opacity="0.45" transform="rotate(-20,97,179)" />
  </Plate>
)
...
export const NecklaceB: FC<SVGProps<SVGSVGElement>> = () => (
  <Plate>
    ...
    {/* Gem facets */}
    <path d="M92 178 L100 170 L108 178 L100 186 Z" stroke="currentColor" strokeWidth="0.5" fill="none" opacity="0.35" />
    {/* Shine */}
    <ellipse cx="96" cy="174" rx="3" ry="2" fill="white" stroke="none" opacity="0.55" transform="rotate(-25,96,174)" />
  </Plate>
)
...
export const NecklaceC: FC<SVGProps<SVGSVGElement>> = () => (
  <Plate>
    ...
    {[0,1,2,3,4,5,6,7,8].map((i) => {
      ...
      return <circle key={i} cx={x} cy={y} r="1.1" fill="currentColor" stroke="none" opacity="0.22" />
    })}
    <line x1="100" y1="130" x2="100" y2="150" strokeWidth="0.7" opacity="0.5" />
    {/* Marquise pendant */}
    <path d="M84 176 Q100 156, 116 176 Q100 196, 84 176 Z" strokeWidth="0.9" fill="currentColor" fillOpacity="0.1" />
    ...
    <ellipse cx="97" cy="173" rx="2.5" ry="1.5" fill="white" stroke="none" opacity="0.5" transform="rotate(-20,97,173)" />
  </Plate>
)
...
export const NecklaceD: FC<SVGProps<SVGSVGElement>> = () => (
  <Plate>
    ...
    {[0,1,2,3,4].map((i) => {
      ...
      return (
        <g key={i}>
          <circle cx={x} cy={y} r={r} strokeWidth={i === 2 ? 1 : 0.7} fill="currentColor" fillOpacity={i === 2 ? 0.7 : 0.45} />
          {i === 2 && <ellipse cx={x - 2} cy={y - 2} rx="2.5" ry="1.5" fill="white" stroke="none" opacity="0.5" />}
        </g>
      )
    })}
...
export const RingA: FC<SVGProps<SVGSVGElement>> = () => (
  <Plate vb="0 0 200 220">
    ...
    {/* Gem — cushion cut */}
    <path d="M78 96 L100 68 L122 96 L116 110 L84 110 Z" strokeWidth="0.9" fill="currentColor" fillOpacity="0.12" />
    ...
    <ellipse cx="96" cy="86" rx="3.5" ry="2" fill="white" stroke="none" opacity="0.55" transform="rotate(-20,96,86)" />
  </Plate>
)
...
export const RingB: FC<SVGProps<SVGSVGElement>> = () => (
  <Plate vb="0 0 200 220">
    ...
    <circle cx="100" cy="82" r="11" strokeWidth="0.6" fill="currentColor" fillOpacity="0.08" opacity="0.8" />
    {/* Gem */}
    <circle cx="100" cy="82" r="7" fill="currentColor" stroke="none" opacity="0.75" />
    <path d="M94 82 L100 76 L106 82 L100 88 Z" stroke="currentColor" strokeWidth="0.4" fill="none" opacity="0.3" />
    <ellipse cx="97" cy="79" rx="3" ry="1.8" fill="white" stroke="none" opacity="0.55" transform="rotate(-25,97,79)" />
  </Plate>
)
...
export const RingC: FC<SVGProps<SVGSVGElement>> = () => (
  <Plate vb="0 0 200 220">
    ...
    {/* Three-stone setting */}
    {[{cx: 76, cy: 88, r: 8, main: false}, {cx: 100, cy: 80, r: 11, main: true}, {cx: 124, cy: 88, r: 8, main: false}].map((gem, i) => (
      <g key={i}>
        <circle cx={gem.cx} cy={gem.cy} r={gem.r + 2} strokeWidth="0.7" fill="none" opacity="0.5" />
        <circle cx={gem.cx} cy={gem.cy} r={gem.r} fill="currentColor" stroke="none" opacity={gem.main ? 0.75 : 0.55} />
        <ellipse cx={gem.cx - 2} cy={gem.cy - 2} rx={gem.main ? 3.5 : 2.5} ry={gem.main ? 2 : 1.5} fill="white" stroke="none" opacity="0.5" transform={`rotate(-25,${gem.cx - 2},${gem.cy - 2})`} />
      </g>
    ))}
  </Plate>
)
...
export const RingD: FC<SVGProps<SVGSVGElement>> = () => (
  <Plate vb="0 0 200 220">
    ...
    {[68, 80, 92, 100, 108, 120, 132].map((cx, i) => (
      <g key={i}>
        <circle cx={cx} cy={94 + Math.abs(cx - 100) * 0.08} r="4.5" strokeWidth="0.6" fill="currentColor" fillOpacity="0.6" />
        <circle cx={cx - 1} cy={92 + Math.abs(cx - 100) * 0.08} r="1.5" fill="white" stroke="none" opacity="0.45" />
      </g>
    ))}
  </Plate>
)
...
export const BraceletA: FC<SVGProps<SVGSVGElement>> = () => (
  <Plate vb="0 0 200 200">
    ...
    {[-40, -20, 0, 20, 40].map((dx, i) => (
      <line key={i} x1={100 + dx} y1={145} x2={100 + dx} y2={150} strokeWidth="0.5" opacity="0.25" stroke="currentColor" />
    ))}
  </Plate>
)
...
export const BraceletB: FC<SVGProps<SVGSVGElement>> = () => (
  <Plate vb="0 0 200 200">
    ...
    {[0,1,2,3,4,5,6,7,8].map((i) => {
      ...
      return (
        <g key={i}>
          <rect x={cx - 5} y={cy - 5} width="10" height="10" strokeWidth="0.7" rx="1" fill="currentColor" fillOpacity={isMain ? 0.12 : 0.08} transform={`rotate(${angle * 57.3 + 90},${cx},${cy})`} />
          <circle cx={cx} cy={cy} r={isMain ? 4.5 : 3.5} fill="currentColor" stroke="none" opacity={isMain ? 0.75 : 0.55} />
          <circle cx={cx - 1} cy={cy - 1} r={isMain ? 1.8 : 1.3} fill="white" stroke="none" opacity="0.5" />
        </g>
      )
    })}
  </Plate>
...
export const BraceletC: FC<SVGProps<SVGSVGElement>> = () => (
  <Plate vb="0 0 200 200">
    ...
    {[0,1,2,3,4,5,6,7].map((i) => {
      ...
      return (
        <ellipse key={i} cx={cx} cy={cy} rx="6" ry="4" strokeWidth="0.7" fill="none" opacity="0.4"
          transform={`rotate(${angle * 57.3},${cx},${cy})`} />
      )
    })}
    {/* Center charm */}
    <path d="M88 82 L100 66 L112 82 L108 92 L92 92 Z" strokeWidth="0.9" fill="currentColor" fillOpacity="0.12" />
...
export const EarringA: FC<SVGProps<SVGSVGElement>> = () => (
  <Plate vb="0 0 200 230">
    {[66, 134].map((cx) => (
      <g key={cx}>
        {/* Ear wire */}
        <path d={`M${cx} 44 Q${cx + 12} 36, ${cx + 12} 52 Q${cx + 12} 68, ${cx} 66`} strokeWidth="0.9" fill="none" />
        {/* Post */}
        ...
        {/* Teardrop drop */}
        <path d={`M${cx - 14} 102 Q${cx} 82, ${cx + 14} 102 Q${cx} 130, ${cx - 14} 102 Z`} strokeWidth="0.9" fill="currentColor" fillOpacity="0.1" />
        ...
        <ellipse cx={cx - 1.5} cy={cx === 66 ? 103 : 103} rx="2.2" ry="1.4" fill="white" stroke="none" opacity="0.55" transform="rotate(-20)" />
      </g>
    ))}
  </Plate>
)
...
export const EarringB: FC<SVGProps<SVGSVGElement>> = () => (
  <Plate vb="0 0 200 230">
    {[66, 134].map((cx) => (
      <g key={cx}>
        {/* Ear wire */}
        <path d={`M${cx} 42 Q${cx + 14} 34, ${cx + 14} 52 Q${cx + 14} 70, ${cx} 68`} strokeWidth="0.9" fill="none" />
        ...
        <path d={`M${cx - 5} 108 L${cx} 102 L${cx + 5} 108 L${cx} 114 Z`} stroke="currentColor" strokeWidth="0.4" fill="none" opacity="0.3" />
        <ellipse cx={cx - 2} cy={105} rx="2.5" ry="1.5" fill="white" stroke="none" opacity="0.55" transform={`rotate(-20,${cx - 2},105)`} />
        {/* Bottom accent */}
...
export const EarringC: FC<SVGProps<SVGSVGElement>> = () => (
  <Plate vb="0 0 200 230">
    {[66, 134].map((cx) => (
      <g key={cx}>
        <path d={`M${cx} 42 Q${cx + 12} 34, ${cx + 12} 50 Q${cx + 12} 66, ${cx} 64`} strokeWidth="0.9" fill="none" />
        <circle cx={cx} cy={42} r="4" strokeWidth="0.8" fill="currentColor" fillOpacity="0.15" />
        {/* Cascading drops */}
        {[0, 1, 2].map((j) => {
          const y = 78 + j * 38
          ...
          return (
            <g key={j}>
              {j > 0 && <line x1={cx} y1={y - 10} x2={cx} y2={y - r} strokeWidth="0.6" opacity="0.4" />}
              <circle cx={cx} cy={y} r={r} strokeWidth={j === 0 ? 0.9 : 0.7} fill="currentColor" fillOpacity={0.7 - j * 0.18} stroke="none" />
              <ellipse cx={cx - 2} cy={y - 2} rx={r * 0.4} ry={r * 0.26} fill="white" stroke="none" opacity="0.5" transform={`rotate(-20,${cx - 2},${y - 2})`} />
            </g>
          )
        })}
      </g>
...
export const SetB: FC<SVGProps<SVGSVGElement>> = () => (
  <Plate vb="0 0 220 220">
    ...
    {/* Pendant */}
    <path d="M160 100 L153 90 L160 78 L167 90 Z" strokeWidth="0.9" fill="currentColor" fillOpacity="0.12" />
...
export const SearchEmpty: FC<SVGProps<SVGSVGElement>> = () => (
  <Plate vb="0 0 200 200">
    ...
    {/* Handle */}
    <line x1="122" y1="122" x2="156" y2="156" strokeWidth="2.8" strokeLinecap="round" opacity="0.55" />
