...
function lighten(hex: string, t: number): string { return blend(hex, [255, 255, 255], t) }
function darken(hex: string, t: number): string  { return blend(hex, [0, 0, 0], t) }
...
export function deriveThemeCSS(
  ...
  const tokens: [string, string][] = [
    ...
    ['--lx-surface',         lightBg ? lighten(bg, 0.40) : lighten(bg, 0.06)],
    ...
    ['--lx-gold',            light],
    ['--lx-dust-rose',       lighten(brand, 0.60)],
