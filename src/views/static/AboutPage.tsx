...
const VALUES = [
  ...
  },
  {
    num: '۰۳',
    title: 'خرید مطمئن',
    body: 'تا ۴ روز پس از دریافت، اگر نظرتان عوض شد قطعه را بدون هزینه بازمی‌گردانیم. همه‌ی قطعات از آلیاژ بدون نیکل با روکش ماندگار ساخته می‌شوند — همین تعهد به کیفیت ما را از بازار پر از جنس بی‌کیفیت متمایز می‌کند.',
  },
]
...
const ABOUT_JSON_LD = {
  ...
  url: 'https://luxera.ir',
  description:
    'فروشگاه تخصصی جواهرات فانتزی ایران — انتخاب دقیق برندهای معتبر، بدون نیکل، با بازگشت رایگان تا ۴ روز',
  contactPoint: {
    '@type': 'ContactPoint',
    ...
    <div className="max-w-[1480px] mx-auto px-[clamp(20px,4vw,56px)] pb-[100px]">
      ...
      <div className="grid grid-cols-[1.2fr_1fr] gap-20 items-start mb-[72px] max-[900px]:grid-cols-1 max-[900px]:gap-10">
        <div>
          ...
          <a href="/category/new" className={`${BTN_CLS} mt-2`}>
            مشاهده‌ی محصولات
