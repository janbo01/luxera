...
const SearchResultsPage: FC<SearchResultsPageProps> = ({ q: qProp }) => {
  ...
  return (
    <PullToRefresh onRefresh={handleRefresh}>
      <Breadcrumb items={[{ label: 'خانه', to: '/' }, { label: 'نتایج جستجو' }]} />
      ...
      <section className="py-[88px] px-[clamp(20px,4vw,56px)]">
        ...
        {loading ? (
          <div
            className="products grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-[18px]"
            style={{ opacity: 0.5 }}
          >
          ...
          <div className="flex flex-col items-center gap-4 px-[clamp(20px,4vw,56px)] py-20 text-center min-h-[50vh]">
            ...
            <a href="/category/new" className={BTN_GHOST_CLS}>
              مشاهده همه محصولات
            </a>
          </div>
        )}
